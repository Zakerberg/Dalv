...
@interface DLAddReduceButton () <UITextFieldDelegate>
/** 减按钮*/
...
@implementation DLAddReduceButton
...
{
    return [[DLAddReduceButton alloc] initWithFrame:frame];
}
#pragma mark - 设置UI子控件
- (void)setupUI
{
    ...
    [_increaseBtn setBackgroundColor:[UIColor colorWithRed:240/255.0 green:240/255.0 blue:240/255.0 alpha:1]];
    [_increaseBtn setTitleColor:[UIColor blackColor] forState:0];
    _increaseBtn.titleLabel.font = [UIFont systemFontOfSize:20];
    [_increaseBtn setTitle:@"+" forState:0];
    [self addSubview:_increaseBtn];

    
    
    _decreaseBtn = [self creatButton];
    [_decreaseBtn setBackgroundColor:[UIColor colorWithRed:240/255.0 green:240/255.0 blue:240/255.0 alpha:1]];
    [_decreaseBtn setTitleColor:[UIColor blackColor] forState:0];
    _decreaseBtn.titleLabel.font = [UIFont systemFontOfSize:20];
    [_decreaseBtn setTitle:@"-" forState:0];
    ...
    _textField.backgroundColor = [UIColor colorWithHexString:@"#7894f2"];
...
- (void)decrease
{
    ...
    if (number >= _minValue) {
        ...
        [[DLHUDManager sharedInstance]showTextOnly:@"请填写正确格式"];
...
@implementation NSString (DLAddReduceButton)
- (BOOL)pp_isNotBlank
{
