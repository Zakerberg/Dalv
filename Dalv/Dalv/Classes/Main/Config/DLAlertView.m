...
static NSString * const DLAlertViewBackgroundImageName = @"wuba_mis_crm_tanchukuang";
...
- (void)configSubviews
{
    ...
    //    CGSize defaultSize = [DLAlertViewDefaultText sizeWithFont:font constrainedToSize:CGSizeMake(textViewWidth, DLAlertViewHeight)];
