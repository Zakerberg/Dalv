...
-(void)createCalendarView
{
    ...
    self.collectionView=[[UICollectionView alloc] initWithFrame:CGRectMake(0, 40, WIDTH, HEIGHT - 40) collectionViewLayout:layout];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.dataSource.count) {
        ...
        if (indexPath.item >= model.firstday) {
            ...
            cell.priceL1.text = [NSString stringWithFormat:@"￥%@", subModel.price];
