...
- (NSMutableArray *)reloadCalendarView:(NSDate *)date  selectDate:(NSDate *)selectdate needDays:(int)days_number
{
    ...
    NSDateComponents *afterDC = [after YMDComponents];
    ...
    NSInteger months = (afterYear - todayYear) * 12 + (afterMonth - todayMonth);
...
- (void)changStyle:(CalendarDayModel *)calendarDay
{
    ...
    //没被点击选中
            ...
            //工作日
                ...
                calendarDay.style = CellDayTypeNormal;
            }
        }
...
- (void)selectLogic:(CalendarDayModel *)day
{
    ...
    //工作日
        ...
        selectcalendarDay.style = CellDayTypeNormal;
    }
